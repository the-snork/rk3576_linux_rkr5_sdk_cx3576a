...
if [ ! -e /oem/config_rhythm_player.json ]; then
	ln -s /etc/pbox/config_rhythm_player.json /oem/config_rhythm_player.json
fi

if [ ! -e /oem/rkstudio.bin ]; then
    ln -s /etc/pbox/rkstudio.bin /oem/rkstudio.bin
fi
if [ ! -e /oem/howling.bin ]; then
	ln -s /etc/pbox/howling.bin /oem/howling.bin
fi
if [ ! -e /oem/RK3308_guitar_separation.bin ]; then
    ln -s /etc/pbox/RK3308_guitar_separation.bin /oem/RK3308_guitar_separation.bin
fi
if [ ! -e /oem/RK3308_vocal_separation.bin ]; then
    ln -s /etc/pbox/RK3308_vocal_separation.bin /oem/RK3308_vocal_separation.bin
fi
...
export rt_cfg_path_vocal_separate=/oem/RK3308_vocal_separation.bin
...
export rt_cfg_path_rhythm_player=/oem/config_rhythm_player.json
...
export recorder_howling_bypass=0
export recorder_level_bypass=1
export recorder_reverb_bypass=0
export recorder_rkstudio_bypass=1
export player_rkstudio_bypass=0
export mixer_rkstudio_bypass=0
export player_gender_bypass=0
export player_vocal_close=0
export player_rhythm_bypass=1
export lv_disp_fps=16
