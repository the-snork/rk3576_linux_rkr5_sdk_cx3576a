...
RkAiqResourceTranslatorV3x& RkAiqResourceTranslatorV3x::SetIspUnitedMode(RkAiqIspUniteMode mode) {
    mIspUniteMode = mode;
    return *this;
}
...
RkAiqIspUniteMode RkAiqResourceTranslatorV3x::GetIspUnitedMode() {
