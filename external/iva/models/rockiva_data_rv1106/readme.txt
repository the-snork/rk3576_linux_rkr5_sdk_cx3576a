...
object_detection_v3_pvn.data 目标检测（人形、机动车、非机动车）输入为896x512(需要配置detModel=ROCKIVA_DET_MODEL_PVN)
...
object_detection_v3_pv.data 目标检测（人形、机动车）输入为896x512(需要配置detModel=ROCKIVA_DET_MODEL_PV)

object_detection_v3_pfcp.data      目标检测（人形、人脸、机动车、宠物）轻量模型，输入为896x512（需要配置detModel=ROCKIVA_DET_MODEL_PFCP）
